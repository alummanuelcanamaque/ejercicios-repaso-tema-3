 ...
 */
package e.pkg3.rb.nivelcombustible;
...
public class combustible extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Capacidad Deposito:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int capacidadDeposito=Integer.valueOf(jTextField1.getText());
        int contenido=Integer.valueOf(jTextField2.getText());
        int reserva=Integer.valueOf(jTextField3.getText());
        int ancho=Integer.valueOf(jTextField4.getText());
        area.setText("");
        
        for (int f = 0; f < capacidadDeposito; f++) {
